        ...
        <>
         ...
         <div>
            {topMovies.length!== 0 && slideMovies.map((movie,index)=>(
                    <div className={HomePageStyles.topRatedCard} style={{position:"absolute",height:'13vw', width:'11vw', backgroundColor:'yellow',boxShadow:'0vw 0.1vw #656568',textAlign:"center", borderRadius:'0.9vw',top:"0",left:width*index+2+"vw"}} onClick={()=>moveToSingle(movie)}> 
